...
def define_env(env):
    ...
    @env.macro
    def periodic_table():
        from echemdb.website.legacy.markdown_pieces import \
            get_periodic_table_span
    ...
    def make_element_surface_page(elementname, surfacename):
        from echemdb.website.legacy.make_pages import \
            get_element_surface_page_contents
